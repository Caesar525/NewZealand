...
{
    public abstract class NEWZEALANDWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NEWZEALANDWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NEWZEALANDWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NEWZEALANDDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NEWZEALANDDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NEWZEALANDDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NEWZEALANDDbContext, Task<T>> func)
        {
            T result;
